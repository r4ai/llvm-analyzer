...
- Language Server による宣言形 hover / opcode・type・attribute hover / definition / references / documentSymbol / documentLink / semanticTokens / diagnostics / completion / rename / foldingRange / formatting。
